...
class ObjectControl:
    """The Object Control class for the Q-GAIN package.
    ...
    .. code-block:: python
        ...
        od_top = Object_Control(model = qgain.soldet.object_model.ObjectDetector,
    ...
    def pos_predict(self, data: list | dict | np.ndarray, model_path: str) -> list:
    ...
    def pos_counter(self, data: dict | np.ndarray, model_path: str) -> list:
